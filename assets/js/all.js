...
function featuresSlider() {
  $(".more-features-slider").owlCarousel({
    autoPlay : 5000, // Integer means autoplay equal to the value. True means autoplay with 5 seconds
    stopOnHover : true,
    slideSpeed : 500,
    navigation : true,
...
$( "*[data-parallax-background-image]" ).each(function() {
	...
	$( this ).css( "background-image" , "url('" + "./assets/admin/img/header/" + customParallaxBackgroundImage + "')" );
});
...
function formSuccess(){
    ...
    var successContent =  '<img src="assets/images/files/form-message/send.png">' +
